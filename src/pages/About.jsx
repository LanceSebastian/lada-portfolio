  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        {/* Photo placeholder */}
        <div className="bg-stone-100 aspect-3/4 w-full flex items-center justify-center text-stone-300 text-sm">
          Photo
        </div>
        ...
        <div>
          ...
          <div className="mt-12 space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {['Editorial Illustration', 'Character Design', 'Digital Art', 'Procreate', 'Adobe Illustrator'].map(skill => (
